...
function GameMenu({ onSelectGame }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GameMenu.useEffect": ()=>{
            ...
            const spheres = [];
            const particles = [];
            // Create main spheres for each game
            GAMES.forEach({
                "GameMenu.useEffect": (game, idx)=>{
                    ...
                    scene.add(sphere);
                    spheres.push(sphere);
                    // Create orbiting particles around each sphere
                    ...
                    particles.forEach({
                        "GameMenu.useEffect.animate": (particle)=>{
                            if (particle.userData.parentIndex !== undefined) {
                                ...
                                particle.position.y = parentSphere.position.y + Math.sin(particle.userData.angle * 0.5) * particle.userData.distance;
                                particle.position.z = Math.sin(particle.userData.angle * 1.2) * particle.userData.distance * 0.5;
                                particle.rotation.x += 0.03;
                                particle.rotation.y += 0.03;
                                // Color pulsing
                                const pulse = Math.sin(time * 2 + particle.userData.parentIndex) * 0.5 + 0.5;
                                particle.material.emissiveIntensity = pulse * 0.8 + 0.2;
                            }
                        }
                    }["GameMenu.useEffect.animate"]);
...
"[project]/hooks/use-three-scene.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function useThreeScene({ containerRef, onAnimate, cameraPosition = {
    z: 30
}, enableShadows = false, fogConfig = {
    color: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].THREE.BACKGROUND_COLOR,
    near: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].THREE.FOG_NEAR,
    far: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].THREE.FOG_FAR
} }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useThreeScene.useEffect": ()=>{
            ...
            const scene = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scene"]();
            if (fogConfig) {
                scene.fog = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fog"](fogConfig.color, fogConfig.near, fogConfig.far);
            }
            // Camera setup
            const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].THREE.FOV, width / height, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].THREE.NEAR, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].THREE.FAR);
            ...
            return ({
                "useThreeScene.useEffect": ()=>{
                    ...
                    scene.traverse({
                        "useThreeScene.useEffect": (object)=>{
                            if (object instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Mesh"]) {
                                ...
                                if (Array.isArray(object.material)) {
                                    object.material.forEach({
                                        "useThreeScene.useEffect": (material)=>material.dispose()
                                    }["useThreeScene.useEffect"]);
                                } else {
...
_s(useThreeScene, "qom8qmah7k4PtqZjdzJoAK0SLDE=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/three/build/three.core.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/three/build/three.module.js [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$three$2d$scene$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/use-three-scene.ts [app-client] (ecmascript)");
...
function NextNumberGame({ onBack }) {
    ...
    const groupsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$three$2d$scene$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThreeScene"])({
        ...
        enableShadows: true,
        onAnimate: {
            "NextNumberGame.useThreeScene": (scene, camera, renderer)=>{
                const time = Date.now() * 0.001;
                groupsRef.current.forEach({
                    "NextNumberGame.useThreeScene": (group)=>{
                        if (group.userData.number !== undefined) {
                            // Rotation
                            group.rotation.x += __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].ANIMATION.ROTATION_SPEED;
                            group.rotation.y += __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].ANIMATION.ROTATION_SPEED;
                            // Floating animation
                            group.position.y = group.userData.targetY + Math.sin(time + group.userData.index) * __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].ANIMATION.FLOAT_AMPLITUDE;
                            group.position.z = Math.sin(time * 0.5 + group.userData.index) * 4;
                            // Mouse influence
                            group.position.x += (mouseRef.current.x * 5 - group.position.x * 0.02) * __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].ANIMATION.MOUSE_INFLUENCE;
                            // Pulsing torus ring
                            if (group.userData.torusRing) {
                                ...
                                group.userData.torusRing.scale.z = 1 + pulsing * 0.3;
                                group.userData.torusRing.material.opacity = pulsing * 0.8 + 0.2;
                            }
                        }
                    }
                }["NextNumberGame.useThreeScene"]);
            }
        }["NextNumberGame.useThreeScene"]
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NextNumberGame.useEffect": ()=>{
            ...
            // This effect will recreate the scene when question changes
            // The actual scene setup is handled by useThreeScene hook
            ...
            question.sequence.forEach({
                "NextNumberGame.useEffect": (num, idx)=>{
                    ...
                    const color = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"]().setHSL(hue, 0.8, 0.5);
                    const sphere = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$three$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSphereMesh"])(1.2, color, {
                        segments: 64,
                        metalness: 0.3,
                        roughness: 0.4,
                        emissiveIntensity: 0.5
                    ...
                    const torusMat = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MeshBasicMaterial"]({
                        color: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"]().setHSL(hue, 0.9, 0.6),
                        transparent: true,
                        opacity: 0.8
                    });
            ...
            // Setup lighting
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$three$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createGameLights"])(scene);
            // Animation loop
            const animate = {
...
_s(NextNumberGame, "/p2QromK3JqoecFNGhZglBOgdFs=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$three$2d$scene$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThreeScene"]
    ];
});
_c = NextNumberGame;
var _c;
        ...
        "MissingNumberGame.useEffect": ()=>{
            ...
            question.sequence.forEach({
                "MissingNumberGame.useEffect": (num, idx)=>{
                    ...
                    // Create cube
                    const color = isNull ? new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].COLORS.LIGHT_PINK) : new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"]().setHSL(Math.random(), 0.7, 0.5);
                    ...
                    if (isNull) {
                        cube.material.emissive = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GAME_CONFIG"].COLORS.LIGHT_PINK).multiplyScalar(0.3);
                    }
                    group.add(cube);
                    // Add edge glow for missing numbers
                    if (isNull) {
                        const edgeGeom = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EdgesGeometry"](new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BoxGeometry"](1.5, 1.5, 1.5));
                    ...
                    groups.forEach({
                        "MissingNumberGame.useEffect.animate": (group)=>{
                            if (group.userData.isNull !== undefined) {
                                ...
                                group.position.y = Math.sin(time + group.userData.index * 0.5) * 2.5;
                                group.position.z = Math.cos(time * 0.7 + group.userData.index) * 2.5;
                                // Mouse interaction for missing cube
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SortSequenceGame.useEffect": ()=>{
            ...
            for(let i = 0; i < particleCount; i++){
                ...
                const particle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$three$2d$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSphereMesh"])(0.3, color, {
                    segments: 32,
                    metalness: 0.5,
                    roughness: 0.3,
            ...
            // Setup lighting with custom colors
                ...
                "SortSequenceGame.useEffect.animate": ()=>{
                    ...
                    particles.forEach({
                        "SortSequenceGame.useEffect.animate": (particle)=>{
                            ...
                            const hue = (time * 0.2 + particle.userData.index * 0.01) % 1;
                            particle.material.color.setHSL(hue, 0.9, 0.6);
                            particle.material.emissive.setHSL(hue, 0.9, 0.4);
                            // Scale pulsing
                            const scale = Math.sin(time * 2 + particle.userData.index * 0.1) * 0.3 + 1;
...
//# sourceMappingURL=_e0394bdb._.js.map