...
;
const metadata = {
    // <CHANGE> Updated title and description for math games
    title: "🎮 Vui Học Toán - Game Quy Luật Số",
    description: "Game toán học vui nhộn cho học sinh lớp 4 - Học quy luật số qua các game interactif",
    generator: "v0.app",
    icons: {
        icon: [
            {
